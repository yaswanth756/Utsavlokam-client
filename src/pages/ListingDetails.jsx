...
const ListingDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        title={`${listing.title} - Utsavlokam`}
        description={listing.description || `Book ${listing.title} for your event on Utsavlokam.`}
        canonical={`https://www.utsavlokam.com/listings/${id}`}
      />
